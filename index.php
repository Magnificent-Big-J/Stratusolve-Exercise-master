...
<script type="text/javascript">
    ...
    $('#saveTask').click(function() {
		 ...
		 var InputTaskName, InputTaskDescription;
		 InputTaskName = $('#InputTaskName').val();
		 InputTaskDescription = $('#InputTaskDescription').val();
		 var indicator = -1;
		 if(InputTaskDescription.length> 0 && InputTaskName.length >0)
		 {
			...
			if(currentTaskId > -1)
			{
			 ...
			 var formData = {'InputTaskName':InputTaskName,
